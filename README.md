...
# Building
You don't need to build anything, in fact it'll work just by dragging the Scripts Pack folder anywhere. But for fun, you can Scripts Pack's create-dmg script. Just run ``./BuildScriptsPackImage`` when in the same directory as the create-dmg folder and ensure you have Xcode and its command-line tools installed. Its output should be placed in the ``Build`` folder.
